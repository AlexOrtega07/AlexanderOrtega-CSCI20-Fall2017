...
int main(){// main function
    ...
    cout << "If you remove the last rock, you win. However, if the computer removes the last rock, you lose."<< endl;
        ...
        computer_Pile = (rand() % 2 + 1);
        computer_Rocks = (rand() % 3 + 1);
